...
class Driver {
    columnType(column) {
        ...
        switch (typeName) {
            ...
            case "circle": {
                typ = typescript_1.factory.createTypeLiteralNode([
                    typescript_1.factory.createPropertySignature(undefined, typescript_1.factory.createIdentifier("x"), undefined, typescript_1.factory.createKeywordTypeNode(typescript_1.SyntaxKind.NumberKeyword)),
                    typescript_1.factory.createPropertySignature(undefined, typescript_1.factory.createIdentifier("y"), undefined, typescript_1.factory.createKeywordTypeNode(typescript_1.SyntaxKind.NumberKeyword)),
                    typescript_1.factory.createPropertySignature(undefined, typescript_1.factory.createIdentifier("radius"), undefined, typescript_1.factory.createKeywordTypeNode(typescript_1.SyntaxKind.NumberKeyword)),
                ]);
                break;
            }
            case "date": {
            ...
            case "interval": {
                typ = typescript_1.factory.createTypeReferenceNode(typescript_1.factory.createIdentifier("IPostgresInterval"), undefined);
                break;
            }
            case "json": {
    ...
    preamble(queries) {
        const imports = [
            typescript_1.factory.createImportDeclaration(undefined, typescript_1.factory.createImportClause(false, undefined, typescript_1.factory.createNamedImports([
                typescript_1.factory.createImportSpecifier(false, undefined, typescript_1.factory.createIdentifier("QueryArrayConfig")),
                typescript_1.factory.createImportSpecifier(false, undefined, typescript_1.factory.createIdentifier("QueryArrayResult")),
            ])), typescript_1.factory.createStringLiteral("pg"), undefined),
        ];
        const hasInterval = queries.some((query) => query.params.some((p) => p.column?.type?.name === "interval") ||
            query.columns.some((c) => c.type?.name === "interval"));
        if (hasInterval) {
            imports.push(typescript_1.factory.createImportDeclaration(undefined, typescript_1.factory.createImportClause(false, undefined, typescript_1.factory.createNamedImports([
                typescript_1.factory.createImportSpecifier(false, undefined, typescript_1.factory.createIdentifier("IPostgresInterval")),
            ])), typescript_1.factory.createStringLiteral("postgres-interval"), undefined));
        }
        imports.push(typescript_1.factory.createInterfaceDeclaration(undefined, typescript_1.factory.createIdentifier("Client"), undefined, undefined, [
            typescript_1.factory.createPropertySignature(undefined, typescript_1.factory.createIdentifier("query"), undefined, typescript_1.factory.createFunctionTypeNode(undefined, [
                typescript_1.factory.createParameterDeclaration(undefined, undefined, typescript_1.factory.createIdentifier("config"), undefined, typescript_1.factory.createTypeReferenceNode(typescript_1.factory.createIdentifier("QueryArrayConfig"), undefined), undefined),
            ], typescript_1.factory.createTypeReferenceNode(typescript_1.factory.createIdentifier("Promise"), [
                typescript_1.factory.createTypeReferenceNode(typescript_1.factory.createIdentifier("QueryArrayResult"), undefined),
            ]))),
        ]));
        return imports;
    }
        ...
        return typescript_1.factory.createFunctionDeclaration([
            ...
            typescript_1.factory.createExpressionStatement(typescript_1.factory.createAwaitExpression(typescript_1.factory.createCallExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("client"), typescript_1.factory.createIdentifier("query")), undefined, [
                typescript_1.factory.createObjectLiteralExpression([
                    typescript_1.factory.createPropertyAssignment(typescript_1.factory.createIdentifier("text"), typescript_1.factory.createIdentifier(queryName)),
                    ...
                    typescript_1.factory.createPropertyAssignment(typescript_1.factory.createIdentifier("rowMode"), typescript_1.factory.createStringLiteral("array")),
                ], true),
            ]))),
        ], true));
    }
    oneDecl(funcName, queryName, argIface, returnIface, params, columns) {
        ...
        return typescript_1.factory.createFunctionDeclaration([
            ...
            typescript_1.factory.createVariableStatement(undefined, typescript_1.factory.createVariableDeclarationList([
                typescript_1.factory.createVariableDeclaration(typescript_1.factory.createIdentifier("result"), undefined, undefined, typescript_1.factory.createAwaitExpression(typescript_1.factory.createCallExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("client"), typescript_1.factory.createIdentifier("query")), undefined, [
                    typescript_1.factory.createObjectLiteralExpression([
                        typescript_1.factory.createPropertyAssignment(typescript_1.factory.createIdentifier("text"), typescript_1.factory.createIdentifier(queryName)),
                        typescript_1.factory.createPropertyAssignment(typescript_1.factory.createIdentifier("values"), typescript_1.factory.createArrayLiteralExpression(params.map((param, i) => typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("args"), typescript_1.factory.createIdentifier((0, utlis_1.argName)(i, param.column)))), false)),
                        typescript_1.factory.createPropertyAssignment(typescript_1.factory.createIdentifier("rowMode"), typescript_1.factory.createStringLiteral("array")),
            ...
            typescript_1.factory.createIfStatement(typescript_1.factory.createBinaryExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("result"), typescript_1.factory.createIdentifier("rows")), typescript_1.factory.createIdentifier("length")), typescript_1.factory.createToken(typescript_1.SyntaxKind.ExclamationEqualsEqualsToken), typescript_1.factory.createNumericLiteral("1")), typescript_1.factory.createBlock([typescript_1.factory.createReturnStatement(typescript_1.factory.createNull())], true), undefined),
            typescript_1.factory.createVariableStatement(undefined, typescript_1.factory.createVariableDeclarationList([
                typescript_1.factory.createVariableDeclaration(typescript_1.factory.createIdentifier("row"), undefined, undefined, typescript_1.factory.createElementAccessExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("result"), typescript_1.factory.createIdentifier("rows")), typescript_1.factory.createNumericLiteral("0"))),
            ], typescript_1.NodeFlags.Const |
                // NodeFlags.Constant |
                typescript_1.NodeFlags.AwaitContext |
                // NodeFlags.Constant |
    ...
    manyDecl(funcName, queryName, argIface, returnIface, params, columns) {
        ...
        return typescript_1.factory.createFunctionDeclaration([
            ...
            typescript_1.factory.createVariableStatement(undefined, typescript_1.factory.createVariableDeclarationList([
                ...
                typescript_1.NodeFlags.ContextFlags |
                typescript_1.NodeFlags.TypeExcludesFlags)),
            typescript_1.factory.createReturnStatement(typescript_1.factory.createCallExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createPropertyAccessExpression(typescript_1.factory.createIdentifier("result"), typescript_1.factory.createIdentifier("rows")), typescript_1.factory.createIdentifier("map")), undefined, [
